...
module PlatformAPI
  ...
  class Client
    ...
    # @return [UserApp]
    def user_app
      @user_app_resource ||= UserApp.new(@client)
    end
  ...
  class SmsNumber
    ...
    #
    # @param account_email_or_account_id: unique email address of account or unique identifier of an account
    def sms_number(account_email_or_account_id)
      @client.sms_number.sms_number(account_email_or_account_id)
    end

    # Recover an account using an SMS recovery code
    #
    # @param account_email_or_account_id: unique email address of account or unique identifier of an account
    def recover(account_email_or_account_id)
      @client.sms_number.recover(account_email_or_account_id)
    end

    # Confirm an SMS number change with a confirmation code
    #
    # @param account_email_or_account_id: unique email address of account or unique identifier of an account
    def confirm(account_email_or_account_id)
      @client.sms_number.confirm(account_email_or_account_id)
    end
  end
  ...
  class UserApp
    ...
    #
    # @param account_email_or_account_id_or_user_app_self: unique email address of account or unique identifier of an account or Implicit reference to currently authorized user
    def list(account_email_or_account_id_or_user_app_self)
      @client.user_app.list(account_email_or_account_id_or_user_app_self)
    end
  end
