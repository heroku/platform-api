...
module PlatformAPI
  ...
  class Client
    ...
    # @return [EnvVar]
    def env_var
      @env_var_resource ||= EnvVar.new(@client)
    end
  ...
  class EnvVar
    ...
    # @param app_id_or_app_name: unique identifier of app or unique name of app
    def list(app_id_or_app_name)
      @client.env_var.list(app_id_or_app_name)
    end

    # Get an env var for app.
    #
    # @param app_id_or_app_name: unique identifier of app or unique name of app
    # @param env_var_name: unique name of the env var
    def info(app_id_or_app_name, env_var_name)
      @client.env_var.info(app_id_or_app_name, env_var_name)
    end
  end
